      ...
      <div className="flex-1 flex min-h-0 bg-gray-100 relative">
        ...
        <div className="w-64 border-r border-gray-100 bg-gray-100 px-4 py-6 flex flex-col gap-2 flex-shrink-0 min-h-0 overflow-y-auto">
          ...
          <button
            ...
            className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${activeTab === 'site' ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-200' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-200'}`}
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="max-w-2xl mx-auto py-4">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className="text-gray-900 font-bold text-lg flex items-center gap-2">
                  ...
                  {t.admin.siteTabTitle}
                </h2>
                <p className="text-gray-400 text-xs mt-1">{t.admin.siteTabDesc}</p>
              </div>
              <button
                onClick={handleSaveConfig}
                disabled={savingConfig}
            ...
            <div className="space-y-5">
              <div className="bg-gray-100 border border-gray-200 rounded-2xl p-5">
                <label className="block text-gray-700 text-sm font-semibold mb-2">{t.admin.siteUrlLabel || 'SITE URL'}</label>
                <input
                  type="text"
                  value={siteUrl}

    ...
    <div ref={containerRef} className="relative flex-1 max-w-md">
      <form onSubmit={handleSubmit} className="flex items-center gap-1.5">
        ...
        <button
          ...
          title={isSearchMode ? '검색 결과 닫기' : '검색 결과 보기'}
          className={`px-3 py-1.5 disabled:bg-gray-100 disabled:text-gray-400 text-sm font-semibold rounded-xl border disabled:border-gray-200 transition-colors whitespace-nowrap flex-shrink-0 ${
            isSearchMode
